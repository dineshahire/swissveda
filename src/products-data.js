...
export const PRODUCTS = {
  tribulus: {
    ...
    eyebrow: 'Ayurvedic Botanical', price: 'CHF 49', img: 'products/tribulus.png',
  ...
  shilajit: {
    ...
    eyebrow: 'Ayurvedic Adaptogen', price: 'CHF 49', img: 'products/shilajit.png',
  ...
  shatavari: {
    ...
    eyebrow: 'Ayurvedic Adaptogen', price: 'CHF 49', img: 'products/shatavari.png',
  ...
  bacopa: {
    ...
    eyebrow: 'Ayurvedic Nootropic', price: 'CHF 49', img: 'products/bacopa.png',
  ...
  turmeric: {
    ...
    eyebrow: 'Ayurvedic Botanical', price: 'CHF 49', img: 'products/turmeric.png',
  ...
  ashwagandha: {
    ...
    eyebrow: 'Ayurvedic Adaptogen', price: 'CHF 49', img: 'products/ashwagandha.png',
