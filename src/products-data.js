...
export const PRODUCTS = {
  tribulus: {
    ...
    eyebrow: 'Ayurvedic Botanical', price: 'CHF 49', img: 'img/tri%202.png', bannerImg: 'img/tribuls.png', mountainImg: 'img/tri%202.png',
  ...
  shilajit: {
    ...
    eyebrow: 'Ayurvedic Adaptogen', price: 'CHF 49', img: 'img/sha1.png', bannerImg: 'img/shila.png', mountainImg: 'img/sha1.png',
  ...
  shatavari: {
    ...
    eyebrow: 'Ayurvedic Adaptogen', price: 'CHF 49', img: 'img/shatavari.png', bannerImg: 'img/shatavari.png', mountainImg: 'img/s1.png',
  ...
  bacopa: {
    ...
    eyebrow: 'Ayurvedic Nootropic', price: 'CHF 49', img: 'img/bacopa.png', bannerImg: 'img/bacopa.png', mountainImg: 'img/baco%202.png',
  ...
  turmeric: {
    ...
    eyebrow: 'Ayurvedic Botanical', price: 'CHF 49', img: 'img/sha1.png', bannerImg: 'img/hero-banner.png',
  ...
  ashwagandha: {
    ...
    eyebrow: 'Ayurvedic Adaptogen', price: 'CHF 49', img: 'img/ashwa.png', bannerImg: 'img/ashwa.png', mountainImg: 'img/ashwag.png',
